...
export default function Programa() {
  ...
  return (
    <Layout title="Orçamento Público">
      ...
      { loading && model && <Table columns={columns} model={model} controlModal={controlModal} setId={setId} title="Programa" path="programa" />}
      ...
      {modalOpen.post ?
        ...
        : modalOpen.update ?
          ...
          : null}
      {modalOpen.delete ?
        <ModalDelete path="programa" id={id} controlModal={controlModal} title={"Confirmar Exclusão?"}></ModalDelete>
        : null
      }
      <ToastContainer />
    </Layout>
